  ...
  function hideElements() {
    ...
    if (!document.getElementById('student-home-btn')) {
      ...
      if (match) {
        ...
        btn.style.cssText = 'position:fixed;top:70px;left:20px;z-index:1000;background:#2563eb;color:#fff;padding:10px 20px;border-radius:8px;text-decoration:none;font-size:16px;font-weight:600;box-shadow:0 2px 8px rgba(0,0,0,0.2);transition:background 0.2s;';
